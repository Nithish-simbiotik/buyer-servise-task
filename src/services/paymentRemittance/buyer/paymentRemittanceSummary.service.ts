...
@Injectable()
export class BuyerPaymentRemittancePdfService {
  constructor(
                                    ...
                                    <td align="left " bgcolor="#ffffff " width="400">
                                      ...
                                      <table border="0" cellpadding="0" cellspacing="0" width="80%">
                                        ...
                                        <tr style="height: 40px;">
                                          ...
                                          <tr style="height: 40px;">
                                            <td style="max-width: 30%;">Supplier</td>
                                            <td style="width: 70%;text-transform: uppercase;">: ${data.supplierName}</td>
                                          </tr>
                                          <tr style="height: 40px;">
                                            <td style="max-width: 30%;">Purchasing Org</td>
...
let options: HTMLToPDFOptions = {
  ...
  try {
    ...
    const pdfUrl = await this.pdfExportService.uploadPaymentRemittance(pdfBuffer,data.id,data.referenceNumber);
    // res.json("done")
