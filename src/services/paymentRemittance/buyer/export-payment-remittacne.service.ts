...
import { GetInvoiceFormService } from './payment-remittance.service';
...
export class ExportPaymentService {
    constructor(
        ...
        private paymentService: GetInvoiceFormService
    ) { }
    ...
    async exportPaymentRemittance(res:Response,user:JwtPayload, pagingDto: PaymentRemittanceFilterDto) {
        ...
        const paymentList = await this.paymentService.exportpaymentRemittanceList(user,pagingDto);
        ...
        for (let i = 0; i < paymentList.length; i++) {
            ...
            sheet.addRow({
                ...
                supplier:paymentList[i].supplierName,
